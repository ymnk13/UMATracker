...
Blockly.Python['img_gray_bgrtogray'] = function(block) {
    ...
    var code = 'cv2.cvtColor({0},cv2.COLOR_BGR2GRAY)'.format(value_img);
...
Blockly.Python['output'] = function(block) {
	...
	// TODO: Assemble Python into code variable.
	var code = 'im_output = {0}'.format(value_output);
	return code;
};
...
Blockly.Blocks['im_circle_mask'] = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField("CircleMaskImg (CenterX,CenterY) =(")
        .appendField(new Blockly.FieldTextInput("190"), "CenterX")
        .appendField(",")
        .appendField(new Blockly.FieldTextInput("10"), "CenterY")
        .appendField(")")
        .appendField("Radius =")
...
Blockly.Python['im_circle_mask'] = function(block) {
  ...
  // TODO: Assemble Python into code variable.
    ...
    code.push('im_mask = np.zeros((width,height,1), dtype=np.uint8)\r\n')
