...
Blockly.Python['operator_and'] = function(block) {
    ...
    // TODO: Assemble Python into code variable.
    var code = Blockly.Python.joinCodesToOperator(value_im_origin,value_im_mask,'cv2.bitwise_and({0},{1})')
    // TODO: Change ORDER_NONE to the correct strength.
    return [code, Blockly.Python.ORDER_NONE];
};
...
Blockly.Python['operator_or'] = function(block) {
    ...
    var value_inputb = Blockly.Python.valueToCode(block, 'inputB', Blockly.Python.ORDER_ATOMIC);
    // TODO: Assemble Python into code variable.
    var code = Blockly.Python.joinCodesToOperator(value_im_origin,value_im_mask,'cv2.bitwise_or({0},{1})')
    // TODO: Change ORDER_NONE to the correct strength.
    return [code, Blockly.Python.ORDER_NONE];
};
